-- FUNCTION: public.st_randompointsinpolygon(geometry, integer)

-- DROP FUNCTION public.st_randompointsinpolygon(geometry, integer);

CREATE OR REPLACE FUNCTION public.st_randompointsinpolygon(
	geom geometry,
	num_points integer)
...
ALTER FUNCTION public.st_randompointsinpolygon(geometry, integer)
    OWNER TO postgres;

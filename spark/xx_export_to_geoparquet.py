# ---------------------------------------------------------------------------------------------------------------------
#
# script to import each Census 2021 data & boundary table from Postgres & export as GeoParquet or Parquet files to AWS S3
#
# PROCESS
#
...
#     b. export as parquet files to local disk
#     c. copy files to S3
#

...
def get_settings(args):
    ...
    if settings['census_year'] == '2016':
        ...
        settings['bdy_table_dicts'] = \
             [{"boundary": "ced", "id_field": "'CED' || ced_code16", "name_field": "ced_name16", "area_field": "areasqkm16"},
             {"boundary": "gccsa", "id_field": "gcc_code16", "name_field": "gcc_name16", "area_field": "areasqkm16"},
             {"boundary": "iare", "id_field": "'IARE' || iar_code16", "name_field": "iar_name16", "area_field": "areasqkm16"},
             {"boundary": "iloc", "id_field": "'ILOC' || ilo_code16", "name_field": "ilo_name16", "area_field": "areasqkm16"},
             {"boundary": "ireg", "id_field": "'IREG' || ire_code16", "name_field": "ire_name16", "area_field": "areasqkm16"},
             {"boundary": "lga", "id_field": "'LGA' || lga_code16", "name_field": "lga_name16", "area_field": "areasqkm16"},
             ...
             {"boundary": "poa", "id_field": "'POA' || poa_code16", "name_field": "'Postcode ' || poa_name16", "area_field": "areasqkm16"},
             ...
             {"boundary": "ssc", "id_field": "'SSC' || ssc_code16", "name_field": "ssc_name16", "area_field": "areasqkm16"},

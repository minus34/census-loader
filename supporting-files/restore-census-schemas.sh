...
curl --insecure https://minus34.com/opendata/census-2016/census_2016_bdys.dmp --output ./census_2016_bdys.dmp
/Applications/Postgres.app/Contents/Versions/16/bin/pg_restore -Fc -d geo -p 5432 -U postgres ./census_2016_bdys.dmp
rm ./census_2016_bdys.dmp

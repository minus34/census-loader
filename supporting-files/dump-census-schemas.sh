...
/Applications/Postgres.app/Contents/Versions/16/bin/pg_dump -Fc -d geo -n ${DATA_SCHEMA} -p 5432 -U postgres -f ${OUTPUT_FOLDER}/${DATA_SCHEMA}.dmp
/Applications/Postgres.app/Contents/Versions/16/bin/pg_dump -Fc -d geo -n ${BDYS_SCHEMA} -p 5432 -U postgres -f ${OUTPUT_FOLDER}/${BDYS_SCHEMA}.dmp
/Applications/Postgres.app/Contents/Versions/16/bin/pg_dump -Fc -d geo -n ${BDYS_2020_SCHEMA} -p 5432 -U postgres -f ${OUTPUT_FOLDER}/${BDYS_2020_SCHEMA}.dmp
